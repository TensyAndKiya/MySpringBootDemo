...
<button onclick="sendMessage2Group()">Send Message To EveryOne</button>
<br/>
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        ...
        var url = "ws://localhost:8888/socket/chat";
    ...
    function sendMessage2Group() {
        if (null !== websocket) {
            var msg = $("#groupMessage").val();
            $.get("/chat/send?msg=" + msg, function (data) {
                console.log(data);
            });
        }
    }
